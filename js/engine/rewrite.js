...
const RewriteEngine = (() => {
  ...
  const SYNONYMS_MAP = {
    ...
    'overall': ['general', 'whole', 'total'],
    'beneficial': ['good', 'helpful', 'useful'],
    'pivotal': ['key', 'crucial', 'vital'],
    'essential': ['vital', 'crucial', 'key'],
    'delve': ['explore', 'look into', 'go deep'],
    'significant': ['major', 'notable', 'clear'],
    'consistent': ['regular', 'steady', 'even'],
    'experience': ['feel', 'face', 'go through'],
    'productivity': ['output', 'efficiency'],
    'establish': ['set up', 'build', 'create'],
    'recommended': ['suggested', 'advised'],
    'various': ['many', 'different', 'several'],
    'challenge': ['problem', 'issue', 'test'],
    'solution': ['answer', 'way out', 'fix'],
    'process': ['step', 'way', 'method'],
    'develop': ['grow', 'create', 'build'],
    'strategy': ['plan', 'approach'],
    'concept': ['idea', 'notion'],
    'impact': ['effect', 'influence', 'change'],
    'interact': ['connect', 'engage'],
    'transform': ['change', 'reshape', 'alter'],
    'enhance': ['improve', 'boost', 'raise'],
    'crucial': ['key', 'vital', 'critical'],
    'effective': ['useful', 'good', 'helpful']
  };
